...
let contractaddress = '0xa25F5B38639F2869B9D57CBe2c7003DA8310CAe5'; // Token Address
let contractaddress2 = '0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82'; // Cake Address
...
async function fetchAccountData() {
  ...
  const rowResolvers = accounts.map(async (address) => {
   ...
   if(humanFriendlyBalance2 == 0){
    document.querySelector(".pupprbalance").innerHTML = "0 PUPPR, Get on <a href='https://exchange.pancakeswap.finance/#/swap?inputCurrency=0x8ac76a51cc950d9822d68b83fe1ad97b32cd580d&outputCurrency=0xa25F5B38639F2869B9D57CBe2c7003DA8310CAe5'>PancakeSwap</a>"
